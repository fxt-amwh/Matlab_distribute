...
MandS.SINS=SINS;
MandS.TR=TR;
save_path=sprintf("MandS_R%d_u%d.mat",R_lw(1,1),uf_lw_m/d2g)
save(save_path,'MandS')
save_path=sprintf("..\\速度匹配\\MandS_R%d_u%d.mat",R_lw(1,1),uf_lw_m/d2g)
save(save_path,'MandS')